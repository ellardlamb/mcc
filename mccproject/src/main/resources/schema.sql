...
CREATE TABLE REGISTRATIONS(ID INT IDENTITY NOT NULL PRIMARY KEY, EVENT_ID VARCHAR(255), CUSTOMER_ID VARCHAR(255), REGISTRATION_DATE TIMESTAMP, NOTES VARCHAR(255));
-- ----------------------------------------------
